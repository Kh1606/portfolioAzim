...
/**
 * Animated pixel-shimmer background. Lifted from an open-source web component
 * (see card_prompt.md) and ported to plain JSX. The effect "appears" when the
 * parent element is hovered/focused and "disappears" on leave. Respects
 * prefers-reduced-motion. Render it as a child of the element you want to hover.
 */
...
function definePixelCanvas() {
  ...
  class PixelCanvasElement extends HTMLElement {
    constructor() {
      ...
      // Bind so add/removeEventListener reference the same function
